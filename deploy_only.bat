@echo off
echo Deploying ConfigGUI (copying files only)...
...
echo 4. Use the dual-pane interface to send commands >> README.txt
echo. >> README.txt
...
echo - Dual-pane interface (Serial Terminal + Command Interface) >> README.txt
echo - Smart command response parsing >> README.txt
